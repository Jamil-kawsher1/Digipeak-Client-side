    ...
    return (
        <div>
            <div className="card">
                ...
                {outstock ? <button disabled className='add-cart-btn'>Add to cart</button> : <button onClick={() => props.handleAddToCart(props.data)} className='add-cart-btn'>Add to Cart</button>}
